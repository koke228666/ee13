...
в файле _[ee13_vars.php](ee13/ee13_vars.php)_ лежат функции для упрощения генерации ответов
...
больше кодов можно глянуть в _[ee13_vars.php](ee13/ee13_vars.php)_
